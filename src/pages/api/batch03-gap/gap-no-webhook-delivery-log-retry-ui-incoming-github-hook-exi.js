...
export default async function handler(req, res) {
  ...
  const body = req.body || {};
  const label = 'No webhook delivery log / retry UI (incoming GitHub hook exi';
  const hint = 'No webhook delivery log / retry UI (incoming GitHub hook exists but no admin view)';
